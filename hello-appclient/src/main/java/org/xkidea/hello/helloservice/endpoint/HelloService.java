 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://helloservice.xkidea.org/", wsdlLocation = "http://localhost:8080/helloservice-war-1.0/HelloService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://helloservice.xkidea.org/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/helloservice-war-1.0/HelloService?WSDL");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://helloservice.xkidea.org/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://helloservice.xkidea.org/", "HelloPort"), Hello.class, features);
    }
